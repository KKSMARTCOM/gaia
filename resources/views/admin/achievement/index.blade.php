                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('admin.achievement.create') }}" class="btn btn-success">Ajouter <i
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @if (!empty($achievements) && $achievements->count() > 0)
                                            @foreach ($achievements as $item)
                                                <tr class="item" item-id="{{ $item->id }}">
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        ...
                                                        <a href="{{ route('admin.achievement.destroy', $item->id) }}"
