                            ...
                            <form action="{{ route('admin.general-setting.update', 1) }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <img style="width:200px" src="{{ asset('uploads/6544546791135603.jpg') }}"
                                            alt="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Footer Logo
                                        Preview</label>
                                    <div class="col-sm-12 col-md-7">
                                        <img style="width:200px" src="{{ asset('uploads/7206761662541045.jpg') }}"
                                            alt="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Fevicon
                                        Preview</label>
                                    <div class="col-sm-12 col-md-7">
                                        <img style="width:200px" src="{{ asset('uploads/836320862668555.jpg') }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
